...
public class Flight {
    ...
    public Flight(GameView gameView, int screenX, int screenY, Resources resources) {
        ...
        shoot1 = BitmapFactory.decodeResource(resources, R.drawable.pane_shoot1);
        shoot2 = BitmapFactory.decodeResource(resources, R.drawable.pane_shoot2);
        shoot3 = BitmapFactory.decodeResource(resources, R.drawable.pane_shoot3);
        shoot4 = BitmapFactory.decodeResource(resources, R.drawable.pane_shoot4);
        shoot5 = BitmapFactory.decodeResource(resources, R.drawable.pane_shoot5);
