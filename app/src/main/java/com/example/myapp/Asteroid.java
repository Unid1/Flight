...
public class Asteroid {
    ...
    public Asteroid(int screenX, int screenY, Resources resources) {
        ...
        asteroid1 = BitmapFactory.decodeResource(resources, R.drawable.meteorite1);
        asteroid2 = BitmapFactory.decodeResource(resources, R.drawable.meteorite2);
        asteroid3 = BitmapFactory.decodeResource(resources, R.drawable.meteorite3);
        asteroid4 = BitmapFactory.decodeResource(resources, R.drawable.meteorite4);
